    ...
    <div className="w-full flex flex-col items-center p-10">
      ...
      <div className="mb-20 text-center">
        ...
        <p className="text-gray-600 max-w-2xl">
          {t("workDescription", "This is my professional journey across different companies, displayed along a timeline. Click on any milestone to view more details.")}
        </p>
      </div>
      ...
      <div className="relative w-4/5 flex justify-between items-center mt-20">
        ...
        {points.map((point, i) => (
          <div key={i} className="relative flex flex-col items-center">
            <motion.div
              className={`w-6 h-6 rounded-full cursor-pointer ${i === activeIndex ? "bg-blue-500" : "bg-gray-400"}`}
              onClick={() => {
  ...
  return (
    <motion.svg width="60" height="90" viewBox="0 0 80 120" fill="none" xmlns="http://www.w3.org/2000/svg">
      <g>
        ...
        <motion.line x1="40" y1="30" x2="25" y2="45" stroke="black" strokeWidth="3"
          animate={{ rotate: [20, -20, 20] }}
          transition={{ duration: swingDuration, repeat: Infinity }}
          style={{ transformOrigin: "40px 30px" }}
        />
        <motion.line x1="25" y1="45" x2="20" y2="65" stroke="black" strokeWidth="3"
          animate={{ rotate: [10, -10, 10] }}
          transition={{ duration: swingDuration, repeat: Infinity }}
          style={{ transformOrigin: "25px 45px" }}
        />
        <motion.line x1="40" y1="30" x2="55" y2="45" stroke="black" strokeWidth="3"
          animate={{ rotate: [-20, 20, -20] }}
          transition={{ duration: swingDuration, repeat: Infinity, repeatType: "mirror" }}
          style={{ transformOrigin: "40px 30px" }}
        />
        <motion.line x1="55" y1="45" x2="60" y2="65" stroke="black" strokeWidth="3"
          animate={{ rotate: [-10, 10, -10] }}
          transition={{ duration: swingDuration, repeat: Infinity }}
          style={{ transformOrigin: "55px 45px" }}
        />
        <motion.line x1="40" y1="60" x2="30" y2="90" stroke="black" strokeWidth="3"
          animate={{ rotate: [-15, 15, -15] }}
          transition={{ duration: swingDuration, repeat: Infinity }}
          style={{ transformOrigin: "40px 60px" }}
        />
        <motion.line x1="30" y1="90" x2="28" y2="115" stroke="black" strokeWidth="3"
          animate={{ rotate: [10, -10, 10] }}
          transition={{ duration: swingDuration, repeat: Infinity }}
          style={{ transformOrigin: "30px 90px" }}
        />
        <motion.line x1="40" y1="60" x2="50" y2="90" stroke="black" strokeWidth="3"
          animate={{ rotate: [15, -15, 15] }}
          transition={{ duration: swingDuration, repeat: Infinity, repeatType: "mirror" }}
          style={{ transformOrigin: "40px 60px" }}
        />
        <motion.line x1="50" y1="90" x2="52" y2="115" stroke="black" strokeWidth="3"
          animate={{ rotate: [-10, 10, -10] }}
          transition={{ duration: swingDuration, repeat: Infinity }}
